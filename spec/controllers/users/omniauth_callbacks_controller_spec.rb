...
describe Users::OmniauthCallbacksController, type: :controller do
  ...
  context "trello" do
    ...
    let(:error_flash) { "Could not authenticate you from Trello because:<ul><li>Email is invalid</li></ul>Note: If you're using Google to sign into Trello, use Google to sign in to Progress Visualizer." }
  ...
  context "twitter" do
    ...
    let(:error_flash) { "Could not authenticate you from Twitter because:<ul><li>Email is invalid</li></ul>" }
  ...
  context "google_oauth2" do
    ...
    let(:error_flash) { "Could not authenticate you from Google Oauth2 because:<ul><li>Email is invalid</li></ul>" }
