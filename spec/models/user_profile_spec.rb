...
describe UserProfile do
  ...
  context "to_csv" do
    ...
    context "user_profile" do
      ...
      it { should  =~ /\d+,\d+,ProgressVisualizer,1,6b6fe08bec7db2ccd331954b03a7800458fdb5732cd87f5defb0493021861d39,52e6778d5922b7e16a641e58,WWtHBRod,\"{\"\"52e6778d5922b7e16a641e59\"\":\"\"To Do\"\",\"\"52e6778d5922b7e16a641e5a\"\":\"\"Doing\"\"}\",\"{\"\"52e6778d5922b7e16a641e5b\"\":\"\"Done\"\"}\",red,7,1,0,9,0,\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},/ }
    end
    ...
    context "done_stories" do
      ...
      it { should  =~ /\d+,\d{4}-\d{2}-\d{2},\d{4}-\d{2}-\d{2},Committed,This Sprint - Pending Deploy,\d+,Story name,1.0,\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},\d+/ }
    end

    context "burn_ups" do
      it { should include("id,timestamp,backlog,done,backlog_estimates,done_estimates,created_at,updated_at,user_profile_id") }
      it { should =~ /\d+,\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},16,4,35.0,11.5,\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},\d{4}-\d{2}-\d{2} \d{2}:\d{2}:\d{2} -\d{4},\d+/ }
    end
  end
end